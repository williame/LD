// explosion from https://www.shadertoy.com/view/XlXSzf by miloszmaki - gorgeous :)
...
vec4 render(vec3 eye, vec3 dir, vec2 fragCoord, float t)
{
    ...
    vec3 pos = eye + dir * STEP * texture2D(iChannel0, fragCoord.xy/iChannelResolution0.x).r;
